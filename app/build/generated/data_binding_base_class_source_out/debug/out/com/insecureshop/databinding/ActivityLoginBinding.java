...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatButton btnLogin, @NonNull TextInputEditText edtPassword,
      @NonNull TextInputEditText edtUserName, @NonNull AppCompatImageView ivTop,
      @NonNull AppCompatTextView lableLogin, @NonNull TextInputLayout textInputPassword,
      @NonNull TextInputLayout textInputUserName) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.lable_login;
      AppCompatTextView lableLogin = ViewBindings.findChildViewById(rootView, id);
      if (lableLogin == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, edtPassword,
          edtUserName, ivTop, lableLogin, textInputPassword, textInputUserName);
    }
